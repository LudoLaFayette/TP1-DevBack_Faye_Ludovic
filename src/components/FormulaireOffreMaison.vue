        ...
        <div class="p-2 border-2 mt-20 bg-indigo-50 rounded-2xl">
            <FormKit type="form" v-model="maison"  @submit="upsertMaison" :submit-attrs="{ classes: { input: 'bg-red-300 p-1 rounded' } }">
                ...
                <FormKit type="file"
                        name="image"
                        label="image"
                        accept=".png,.jpeg,.svg,.web,.jpg,.pdf"
                        help="Formats autorisés:.png,.jpeg,.svg,.web,.jpg,.pdf"
                        multiple
                :config="{
                    classes: {
                    input: 'p-1 rounded border-gray-300 shadow-sm border',
                ...
                <FormKit name="adress" label="adress"
                :config="{
                    classes: {
                    input: 'p-1 rounded border-gray-300 shadow-sm border',
                    label: 'text-gray-600',
                ...
                <FormKit name = "nbrBeds" label="nbrBeds" type = "number"
                :config="{
                    classes: {
                    input: 'p-1 rounded border-gray-300 shadow-sm border',
                    label: 'text-gray-600',
                ...
                <FormKit name="dimension" label="dimension"
                :config="{
                    classes: {
                    input: 'p-1 rounded border-gray-300 shadow-sm border',
                    label: 'text-gray-600',
